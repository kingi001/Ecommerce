...
<head>
    ...
    <title>Belkins Online Store - Lipa na mpesa</title>
    <link
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" >
    ...
    <style>
      ...
      .justify-content-left div:hover {
        background: #545ebd;
        color: #fff;
        cursor: pointer;
      }

      .justify-content-left div:nth-child(1) {
        background: #545ebd;
        color: #fff;
      }
      ...
      <div class="card mt-2 px-3 py-4">
        ...
        <div class="media mt-3 pl-2">
            ...
            <div class="col-12">
                ...
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Amount Ksh</label>
                  <input type="text" class="form-control" name="amount" placeholder="Enter Amount">
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label" >Phone Number</label>
                  <input type="text" class="form-control" name="phone"  placeholder="Enter Phone Number" value = "254">
                </div>
